...
clc;
clear all;
num = [1 0]; %a -> coefficients of y[n] Changable to see what happens
den = [1 -1]; %b -> coefficients of x[n] Changable to see what happens
...
w = 0:pi/32:pi; % Omega Frequency Changable
